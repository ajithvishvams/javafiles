...
public class GenericClass {
	...
	public static void main(String args[]) {
		...
		Person<String, Float, Double> p1 = new Person<String, Float, Double>("Ajith", 10f, 1.0);
		...
		Person<Character, Integer, Integer> p2 = new Person<Character, Integer, Integer>('A', 10, 10);
